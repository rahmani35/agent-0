...
Deploys the ADK Agent to Google Cloud Vertex AI Agent Engine as a managed service.
"""
...
def deploy_to_agent_engine(
    ...
    location: str,
    staging_bucket: str,
    display_name: str = "adk-reasoning-agent",
    description: str = "ADK reasoning agent for summarization and math calculations",
):
    ...
    try:
        ...
        print(f"[!] Required SDKs not installed. Please run: pip install -r requirements.txt\nError: {e}")
        sys.exit(1)
...
def test_remote_agent(resource_name: str, project_id: str, location: str):
    ...
    sample_prompt = "What is the square root of 144 multiplied by 15? Show step-by-step calculation."
    print(f"\n[*] Sending test query:\n    \"{sample_prompt}\"\n")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Deploy, list, or test ADK Agent on Vertex AI Agent Engine")
    ...
    parser.add_argument("--name", default="adk-reasoning-agent", help="Display name of the agent engine")
